...
DROP DATABASE IF EXISTS 'classicmodels_noindex';
CREATE DATABASE /*!32312 IF NOT EXISTS*/`classicmodels_noindex` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `classicmodels_noindex`;
